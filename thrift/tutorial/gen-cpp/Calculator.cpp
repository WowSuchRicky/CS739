...
uint32_t Calculator_sum_args::read(::apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->nums.resize(_size5);
            uint32_t _i9;
            for (_i9 = 0; _i9 < _size5; ++_i9)
            {
              xfer += iprot->readI64(this->nums[_i9]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.nums = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Calculator_sum_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_sum_args");

  xfer += oprot->writeFieldBegin("nums", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter10 = this->nums.begin(); _iter10 != this->nums.end(); ++_iter10)
    {
...
Calculator_sum_pargs::~Calculator_sum_pargs() throw() {
}


uint32_t Calculator_sum_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_sum_pargs");

  xfer += oprot->writeFieldBegin("nums", ::apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I64, static_cast<uint32_t>((*(this->nums)).size()));
    std::vector<int64_t> ::const_iterator _iter11;
    for (_iter11 = (*(this->nums)).begin(); _iter11 != (*(this->nums)).end(); ++_iter11)
    {
...
Calculator_sum_result::~Calculator_sum_result() throw() {
}


uint32_t Calculator_sum_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_sum_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Calculator_sum_result");
...
Calculator_sum_presult::~Calculator_sum_presult() throw() {
}


uint32_t Calculator_sum_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void CalculatorClient::send_sum(const std::vector<int64_t> & nums)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("sum", ::apache::thrift::protocol::T_CALL, cseqid);

  Calculator_sum_pargs args;
  args.nums = &nums;
  args.write(oprot_);
...
void CalculatorClient::recv_sum()
{
...
void CalculatorProcessor::process_sum(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Calculator.sum", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Calculator.sum");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Calculator.sum");
  }

  Calculator_sum_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Calculator.sum", bytes);
  }

  Calculator_sum_result result;
  try {
    iface_->sum(args.nums);
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Calculator.sum");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Calculator.sum");
  }
...
int32_t CalculatorConcurrentClient::send_sum(const std::vector<int64_t> & nums)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("sum", ::apache::thrift::protocol::T_CALL, cseqid);
...
void CalculatorConcurrentClient::recv_sum(const int32_t seqid)
{
