...
void Blah::__set_num1(const int32_t val) {
  this->num1 = val;
}

void Blah::__set_num2(const double val) {
  this->num2 = val;
}

uint32_t Blah::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Blah::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Blah");
...
Blah::Blah(const Blah& other3) {
  num1 = other3.num1;
  num2 = other3.num2;
  __isset = other3.__isset;
}
Blah& Blah::operator=(const Blah& other4) {
  num1 = other4.num1;
  num2 = other4.num2;
  __isset = other4.__isset;
  return *this;
}
void Blah::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "Blah(";
  out << "num1=" << to_string(num1);
  out << ", " << "num2=" << to_string(num2);
