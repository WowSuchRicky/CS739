...
typedef struct _Blah__isset {
  _Blah__isset() : num1(false), num2(false) {}
  bool num1 :1;
  bool num2 :1;
} _Blah__isset;
...
class Blah {
 public:
  ...
  bool operator < (const Blah & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const Blah& obj)
{
  obj.printTo(out);
  return out;
}
